...
const config = {
  ...
  botName: botName,
  customComponents: {
   header: () => <div className='chatbot-header'><Avatar alt='Hawk Bot' sx={{display:"inline-block",margin:"8px"}} src={require("../assets/hawk_image.jpg")} /> HawkBot</div>,
   botAvatar: (props) => <Avatar alt='Hawk Bot'src={require("../assets/hawk_image.jpg")} {...props} />,
